            ...
            <form className="space-y-8">
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input autoComplete="off" className="w-full bg-black border border-white/5 focus:border-primary/50 focus:ring-1 focus:ring-primary/20 text-primary placeholder:text-slate-700 py-4 pl-12 pr-4 transition-all outline-none font-mono text-sm" placeholder="username or email" type="text" />
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                ...
                <div className="relative">
                  ...
                  <input className="w-full bg-black border border-white/5 focus:border-primary/50 focus:ring-1 focus:ring-primary/20 text-primary placeholder:text-slate-700 py-4 pl-12 pr-4 transition-all outline-none font-mono text-sm" placeholder="••••••••••••" type="password" />
                </div>
              </div>
              <div className="pt-4">
                <button className="w-full bg-primary text-black font-bold uppercase tracking-[0.2em] py-4 hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 group/btn shadow-[0_0_20px_rgba(16,209,205,0.15)]">
                  <span className="text-sm">Terminal Access</span>
                  <span className="material-symbols-outlined text-lg group-hover/btn:translate-x-1 transition-transform">login</span>
                </button>
              </div>
            </form>
